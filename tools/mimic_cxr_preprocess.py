...
"""A set of tools to preprocess MIMIC-CXR dataset.

The code was adapted from https://github.com/MIT-LCP/mimic-cxr.
"""
...
def main(args):
    ...
    parser.add_argument('--no_split', action='store_false',
    ...
    for s in tqdm(studies):
        ...
        if idx == -1:
            ...
            print(f'no indication/history: {s}')
        else:
    ...
    if len(patient_studies) > 0:
        ...
        with open(output_path / 'mimic_cxr_sectioned.csv', 'w') as fp:
            ...
            # write header
            csvwriter.writerow(['study', 'indication', 'history'])
